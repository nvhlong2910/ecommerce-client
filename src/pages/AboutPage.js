    ...
    <div className="container-fluid p-0">
      <div className="row no-gutters">
        <div className="col-lg-3 col-md-6">
          {/* Begin Electric market Counter Area */}
          <div className="electricmarket-counter white-smoke-bg">
            <div className="container">
          ...
          {/* Electric market Counter Area End Here */}
        </div>
        <div className="col-lg-3 col-md-6">
          {/* Begin Electric market Counter Area */}
          <div className="electricmarket-counter gray-bg">
            <div className="counter-img">
        ...
        <div className="col-lg-3 col-md-6">
          {/* Begin Electric marketCounter Area */}
          <div className="electricmarket-counter white-smoke-bg">
            <div className="counter-img">
